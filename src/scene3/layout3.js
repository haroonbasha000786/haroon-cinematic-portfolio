...
export const YEARS = [
  { year: 2019, key: 'Webberax', lines: ['Digital marketing', 'B.E. completed'] },
  { year: 2021, key: 'Truefoodstore', lines: ['Social campaigns', 'WordPress'] },
  { year: 2022, key: 'Freelance Work', lines: ['Graphic design', 'Freelance'] },
  { year: 2023, key: 'Integfarms', lines: ['Senior Designer', 'MBA completed'] },
  { year: 2026, key: 'Integfarms My Health School', lines: ['Senior Graphic Designer', 'Full-time'] },
];
...
const REF = {
  ...
  cards: [
    ...
    [0.4250, 0.4097, 0.095],
    [0.5375, 0.4583, 0.102],
    // Close the removed 2025 slot while retaining the final card's larger scale.
    [0.6740, 0.5070, 0.124],
  ],
