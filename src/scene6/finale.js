...
import { finalePortrait } from '../lib/finale-portrait.js';
...
export class Finale {
  ...
  async load() {
    ...
    // Preserve the new portrait's proportions at the existing center and height.
    const [x, y, oldWidth, height] = this.manBox;
    const width = height * man.width / man.height;
    this.manBox = [x + (oldWidth - width) / 2, y, width, height];
  }
